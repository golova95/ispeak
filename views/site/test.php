...
<!--                </li>-->
                <li>
                    <a href="investigaciones/favoritas"><i class="fa fa-fw fa-user-plus"></i>  СТУДЕНТА</a>
                </li>
                <li>
                    <a href="sugerencias"><i class="fa fa-fw fa-group"></i> ГРУППУ</a>
                </li>
                <li>
                    <a href="faq"><i class="fa fa-fw fa fa-pencil"></i> ПРЕПАДОВАТЕЛЯ</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                    <h1><i class="fa fa-fw fa-pencil"></i></h1>
                </div>
            </div>
            <!-- /.row -->
        </div>
